...
contract GuessTheNumber is Ownable {
    ...
    // Constructor to initialize the contract with reward token address and reward amount
    constructor(
    ...
    // Function to start a new game, generates a new secret number
    ...
    function makeGuess(uint256 _guess) public {
        ...
        if (_guess == secretNumber) {
            lastWinner = msg.sender; // Set the winner's address
